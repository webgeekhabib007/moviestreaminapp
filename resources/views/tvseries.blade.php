...
<body
  ...
  <header class="page-header" style="background-image: url(http://digiflex.themezinho.net/wp-content/uploads/2020/12/page-header-bg.jpg)">
  <div class="container">
    <h1>TV Shows</h1>
    ...
    <div class="container">
      <div class="row">
          ...
          <div class="category-thumb">
			  <figure class="category-image"><a href="http://digiflex.themezinho.net/tv-show/thinking-you/"><img src="http://digiflex.themezinho.net/wp-content/uploads/2020/12/tv-shows01.jpg" alt="Thinking You"></a></figure>
            <div class="category-content">
                            <ul class="tags">
                                <li>Action</li>
                              </ul>
                            <h3 class="name">Thinking You</h3>
              <div class="play-btn"><a href="http://digiflex.themezinho.net/tv-show/thinking-you/"> +</a></div>
              <small class="details">
				  				  5 Seasons				          <span>-</span>
				           2017				                 </small> </div>
        ...
        <!-- end col-3 -->
                ...
                <div class="col-lg-3 col-sm-6">
          <div class="category-thumb">
			  <figure class="category-image"><a href="http://digiflex.themezinho.net/tv-show/civil-war/"><img src="http://digiflex.themezinho.net/wp-content/uploads/2020/12/tv-shows02.jpg" alt="Civil War"></a></figure>
            <div class="category-content">
                            <ul class="tags">
                                <li>Adventure</li>
                              </ul>
                            <h3 class="name">Civil War</h3>
              <div class="play-btn"><a href="http://digiflex.themezinho.net/tv-show/civil-war/"> +</a></div>
              <small class="details">
				  				  7 Seasons				          <span>-</span>
				           2015				                 </small> </div>
            <!-- end category-content -->
        ...
        <!-- end col-3 -->
                ...
                <div class="col-lg-3 col-sm-6">
          <div class="category-thumb">
			  <figure class="category-image"><a href="http://digiflex.themezinho.net/tv-show/best-game/"><img src="http://digiflex.themezinho.net/wp-content/uploads/2020/12/tv-shows03.jpg" alt="Best Game"></a></figure>
            <div class="category-content">
                            <ul class="tags">
                                <li>Comedy</li>
                              </ul>
                            <h3 class="name">Best Game</h3>
              <div class="play-btn"><a href="http://digiflex.themezinho.net/tv-show/best-game/"> +</a></div>
              <small class="details">
				  				  1 Season				          <span>-</span>
				           2019				                 </small> </div>
            <!-- end category-content -->
        ...
        <!-- end col-3 -->
                ...
                <div class="col-lg-3 col-sm-6">
          <div class="category-thumb">
			  <figure class="category-image"><a href="http://digiflex.themezinho.net/tv-show/antoshka/"><img src="http://digiflex.themezinho.net/wp-content/uploads/2020/12/tv-shows04.jpg" alt="Antoshka"></a></figure>
            <div class="category-content">
                            <ul class="tags">
                                <li>Crime</li>
                              </ul>
                            <h3 class="name">Antoshka</h3>
              <div class="play-btn"><a href="http://digiflex.themezinho.net/tv-show/antoshka/"> +</a></div>
              <small class="details">
				  				  2 Seasons				          <span>-</span>
				           2019				                 </small> </div>
            <!-- end category-content -->
