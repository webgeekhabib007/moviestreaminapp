...
<body class="home page-template page-template-page-home page-template-page-home-php page page-id-2 user-registration-page wpb-js-composer js-comp-ver-6.10.0 vc_responsive">
    ...
    <header class="page-header single">
        <div class="poster-bg" data-background="http://digiflex.themezinho.net/wp-content/uploads/2020/12/movies15.jpg"></div>
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="video-player">
                        <iframe width="900" height="506" src="https://www.youtube.com/embed/NRuOTkSgDbs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> <!-- end video-player -->
                    </div>
                    <!-- end col-12 -->
                </div>
                <!-- end row -->
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="movie-info-box">
                            ...
                            <div class="features">
                                <div class="rate">
                                    <svg class="circle-chart" viewBox="0 0 30 30" width="40" height="40" fill="transparent" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <circle class="circle-chart__circle" stroke="#4eb04b" stroke-width="2" stroke-dasharray="54,100" cx="15" cy="15" r="14"></circle>
                                    </svg>
                                    <b>
                                        6.2 </b> <img src="http://digiflex.themezinho.net/wp-content/themes/digiflex/images/imdb-logo.svg" alt="IMDB"> Score
                                </div>
                                <!-- end rate -->
                                <div class="year">
                                    2020 </div>
                            ...
                            <!-- end features -->
                            <p class="description">
                                Nine year-old orphan <strong>Beth Harmon</strong> is quiet, sullen, and by all appearances unremarkable. That is, until she plays her first game of chess. Her senses grow sharper, her thinking clearer, and for the first time in her life she feels herself fully in control. By the <u>age of sixteen</u>, she's competing for the U.S. </p>
                            <ul class="info">
                                <li>
                                    <h6>Director</h6>
                                    : <span>
                                ...
                                <li>
                                    <h6>Casting</h6>
                                    : <span>
                                        Andrea Autullo, Jeffrey Voice, Chiara Pavoni </span>
                                </li>
                                <li>
                                    <h6>Production</h6>
                                    : <span>
                    ...
                    <div class="col-lg-3">
                        <div class="movie-side-box">
                            <figure><img src="http://digiflex.themezinho.net/wp-content/uploads/2020/12/movies15.jpg" alt="Deep Darkness"></figure>
                        </div>
                        <!-- end movie-side-box -->
                    </div>
                    <!-- end col-3 -->
                    <div class="col-12">
                        <div class="info-bottom">
                            <div class="add-btn">
                                <div class="simplefavorite-button" data-postid="117" data-siteid="1" data-groupid="1" data-favoritecount="0" style="">+ ADD YOUR LIST</div>
                            </div>
                            <div class="pld-like-dislike-wrap pld-template-1">
                                <div class="pld-like-wrap  pld-common-wrap">
                                    <a href="javascript:void(0)" class="pld-like-trigger pld-like-dislike-trigger  " title="" data-post-id="117" data-trigger-type="like" data-restriction="no" data-already-liked="0">
                                        <i class="fas fa-thumbs-up"></i>
                                    </a>
                                    <span class="pld-like-count-wrap pld-count-wrap">2 </span>
                                </div>
                                <div class="pld-dislike-wrap  pld-common-wrap">
                                    <a href="javascript:void(0)" class="pld-dislike-trigger pld-like-dislike-trigger  " title="" data-post-id="117" data-trigger-type="dislike" data-restriction="no" data-already-liked="0">
